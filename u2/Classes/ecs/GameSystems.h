...
{
public:
    ScaleSystem(const u2::String& type, const u2::String& name, const u2::String& guid = BLANK);
    virtual ~ScaleSystem();
...
class PredictSelfSystem : public System
{
public:
    PredictSelfSystem(const u2::String& type, const u2::String& name, const u2::String& guid = BLANK);
    virtual ~PredictSelfSystem();
