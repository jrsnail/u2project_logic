#ifndef __U2ResourceGroupManager_H__
#define __U2ResourceGroupManager_H__
...
*/
class _U2Export ResourceGroupListener
{
public:
...
public:
    ...
    virtual InStreamPtr resourceLoading(const String &name, const String &group, Resource *resource) = 0;
    ...
    */
    virtual void resourceStreamOpened(const String &name, const String &group, Resource *resource, InStreamPtr& dataStream) = 0;
...
*/
class _U2Export ResourceGroupManager : public Singleton<ResourceGroupManager>, public ResourceAllocatedObject
{
public:
...
protected:
    ...
    /// Map of loading order (u2real) to ScriptLoader, used to order script parsing
    typedef multimap<u2real, ScriptLoader*>::type ScriptLoaderOrderMap;
    ...
    struct ResourceGroup
    {
        ...
        typedef map<u2real, LoadUnloadResourceList*>::type LoadResourceOrderMap;
...
public:
    ...
    */
	InStreamPtr openResource(const String& resourceName,
        const String& groupName = DEFAULT_RESOURCE_GROUP_NAME,
    ...
    @return Shared pointer to a data stream list , will be
        destroyed automatically when no longer referenced
    */
    InStreamListPtr openResources(const String& pattern, 
        const String& groupName = DEFAULT_RESOURCE_GROUP_NAME);
    ...
    */
    OutStreamPtr createResource(const String& filename, const String& groupName = DEFAULT_RESOURCE_GROUP_NAME, 
        bool overwrite = false, const String& locationPattern = BLANK);
    ...
    */
    void deleteResource(const String& filename, const String& groupName = DEFAULT_RESOURCE_GROUP_NAME, 
        const String& locationPattern = BLANK);
