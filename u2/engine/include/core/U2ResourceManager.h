#ifndef __U2ResourceManager_H__
#define __U2ResourceManager_H__
...
*/
class _U2Export ResourceManager : public ScriptLoader, public ResourceAllocatedObject
{
public:
    ...
    */
    ...
    @param groupName The name of the resource group that resources which are
        ...
        with it.
    */
    virtual void parseScript(InStreamPtr& stream, const String& groupName)
    ...
    */
    class _U2Export ResourcePool : public Pool<ResourcePtr>, public ResourceAllocatedObject
    {
    protected:
        String mName;
    public:
...
public:
    typedef U2_HashMap< String, ResourcePtr > ResourceMap;
    typedef U2_HashMap< String, ResourceMap > ResourceWithGroupMap;
