#ifndef __U2Resource_H__
#define __U2Resource_H__
...
*/
class _U2Export Resource : public StringInterface, public ResourceAllocatedObject
{
public:
...
public:
    ...
    */
    ...
    /** Prepares the resource for load, if it is not already.  One can call prepare()
        ...
        itself, if needed.  When U2_THREAD_SUPPORT==1 both load() and prepare() 
        are thread-safe.  When U2_THREAD_SUPPORT==2 however, only prepare() 
    ...
    */
    ...
    @remarks
        ...
        thread support (U2_THREAD_SUPPORT). If a resource has been marked
...
@note
    ...
    at any time.
*/
class _U2Export ManualResourceLoader
{
public:
    ...
    /** Called when a resource wishes to load.  Note that this could get
        ...
        * (U2_THREAD_SUPPORT==2).  Thus, you must not access the rendersystem from
