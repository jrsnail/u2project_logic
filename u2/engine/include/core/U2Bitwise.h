#ifndef __U2Bitwise_H__
#define __U2Bitwise_H__
...
public:
    ...
    */
    static FORCEINLINE u2uint16 bswap16(u2uint16 arg)
    {
#if U2_COMPILER == U2_COMPILER_MSVC && U2_COMP_VER >= 1310
        return _byteswap_ushort(arg);
#elif (U2_COMPILER == U2_COMPILER_CLANG && __has_builtin(__builtin_bswap16)) || (U2_COMPILER == U2_COMPILER_GNUC && U2_COMP_VER >= 480)
    ...
    /** Returns value with reversed bytes order.
    */
    static FORCEINLINE u2uint32 bswap32(u2uint32 arg)
    {
#if U2_COMPILER == U2_COMPILER_MSVC && U2_COMP_VER >= 1310
        return _byteswap_ulong(arg);
#elif (U2_COMPILER == U2_COMPILER_CLANG && __has_builtin(__builtin_bswap32)) || (U2_COMPILER == U2_COMPILER_GNUC && U2_COMP_VER >= 430)
    ...
    /** Returns value with reversed bytes order.
    */
    static FORCEINLINE u2uint64 bswap64(u2uint64 arg)
    {
#if U2_COMPILER == U2_COMPILER_MSVC && U2_COMP_VER >= 1310
        return _byteswap_uint64(arg);
#elif (U2_COMPILER == U2_COMPILER_CLANG && __has_builtin(__builtin_bswap64)) || (U2_COMPILER == U2_COMPILER_GNUC && U2_COMP_VER >= 430)
    ...
    */
    static inline unsigned int intRead(const void *src, int n)
    {
        ...
        {
            case 1:
                return ((const u2uint8*)src)[0];
            case 2:
                return ((const u2uint16*)src)[0];
            case 3:
#if U2_ENDIAN == U2_ENDIAN_BIG      
                return ((u2uint32)((const u2uint8*)src)[0]<<16)|
                        ((u2uint32)((const u2uint8*)src)[1]<<8)|
                        ((u2uint32)((const u2uint8*)src)[2]);
#else
                return ((u2uint32)((const u2uint8*)src)[0])|
                        ((u2uint32)((const u2uint8*)src)[1]<<8)|
                        ((u2uint32)((const u2uint8*)src)[2]<<16);
#endif
            case 4:
                return ((const u2uint32*)src)[0];
        } 
        return 0; // ?
    }
    ...
    */
    static inline u2uint16 floatToHalfI(u2uint32 i)
    {
        ...
        if (e <= 0)
        {
            ...
            return static_cast<u2uint16>(s | (m >> 13));
        }
        else if (e == 0xff - (127 - 15))
        {
            if (m == 0) // Inf
            {
                return static_cast<u2uint16>(s | 0x7c00);
            } 
            else    // NAN
            {
                m >>= 13;
                return static_cast<u2uint16>(s | 0x7c00 | m | (m == 0));
            }
        }
        else
        {
            ...
            return static_cast<u2uint16>(s | (e << 10) | (m >> 13));
        }
    }
