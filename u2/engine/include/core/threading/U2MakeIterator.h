 ...
 */
#ifndef __U2MakeIterator_H__
#define __U2MakeIterator_H__
...
class FunctionInputIterator
	: public std::iterator<std::input_iterator_tag, decltype(std::declval<Function>()())> 
{
